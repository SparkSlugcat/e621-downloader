...
ZH = {
    ...
    "browse": "浏览...",
    "hint_tags": "示例: feline 或 feline,order:score",
    "page_label": "页码（留空=全部页）:",
    "page_size_label": "每页数量:",
    "hint_page": "填入页码则只下载该页（每页数量可自选），留空则下载全部",
    "artist_label": "艺术家标签:",
...
EN = {
    ...
    "browse": "Browse...",
    "hint_tags": "e.g. feline or feline,order:score",
    "page_label": "Page (empty = all pages):",
    "page_size_label": "Posts per page:",
    "hint_page": "Enter a page number to download only that page (choose posts per page); leave empty for all",
